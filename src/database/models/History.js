...
class History {
    /**
     * Add track to history (batched for performance)
     * Uses HistoryBatcher to queue entries and batch INSERT them
     * @param {string} guildId - Discord guild ID
     * @param {string} userId - Discord user ID
     * @param {Object} track - Track information
     * @returns {boolean} Success (queued, not yet persisted)
     */
    ...
    /**
     * Add track to history directly (non-batched)
     * Used when batcher is not running or for immediate writes
     * @param {string} guildId - Discord guild ID
     * @param {string} userId - Discord user ID
     * @param {Object} track - Track information
