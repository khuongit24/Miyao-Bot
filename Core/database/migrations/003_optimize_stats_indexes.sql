-- Migration 003: Optimize Statistics Queries with Composite Indexes
-- Purpose: Add composite indexes to dramatically speed up statistical queries
...
INSERT OR IGNORE INTO migrations (version, name) VALUES ('003', 'optimize_stats_indexes');
